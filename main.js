...
(function themeSwitch() {
  ...
  // Fall back to the visitor's OS-level dark/light preference before
  // defaulting to light — respects their system setting on a first
  // visit, rather than assuming everyone wants light mode.
  const systemPrefersDark = window.matchMedia('(prefers-color-scheme: dark)').matches;
  const savedTheme = readStoredTheme() || (systemPrefersDark ? 'dark' : 'light');
